...
const initialState: ComparisonState = {
  ...
  selectedInstances: [],
  baseInstanceId: null,
  currentFetchEndpoint: '/Biz/v2/api/call/SI.Client.Api.Admin/SI.Client.Api.Admin.ConfigCompareManager/ConfigCompareManager/GetAllSettings',
  currentSaveEndpoint: '/Biz/v2/api/call/SI.Client.Api.Admin/SI.Client.Api.Admin.ConfigCompareManager/ConfigCompareManager/UpdateSettings',
